...
import com.mobilebytes.andhand.exception.ResourceMessageException;
import com.mobilebytes.andhand.support.DiagnosticSupport;
import com.mobilebytes.andhand.support.IntentSupport;

public class ActivityHelper {


	private static final String PROGRESS_DIALOG_TITLE_RESOURCE = "andhand_progress_dialog_title";

    private static final String PROGRESS_DIALOG_MESSAGE_RESOURCE = "andhand_progress_dialog_message";

    public static final String ERROR_DIALOG_TITLE_RESOURCE = "andhand_error_dialog_title";
    ...
    public static int getWindowFeatures(Activity activity) {
        ...
        try {
        	...
        	return (Integer) getFeatures.invoke(window);
    ...
    public static AlertDialog newErrorHandlerDialog(final Activity activity, String dialogTitle,
        ...
        if (IntentSupport.isIntentAvailable(activity, Intent.ACTION_SEND,
            ...
            int buttonId = activity.getResources().getIdentifier(
                    "andhand_dialog_button_send_error_report", "string", activity.getPackageName());
            String buttonText = activity.getString(buttonId);
            int bugEmailAddressId = activity.getResources().getIdentifier(
                    "andhand_error_report_email_address", "string", activity.getPackageName());
            ...
            int bugEmailSubjectId = activity.getResources().getIdentifier(
                    "andhand_error_report_email_subject", "string", activity.getPackageName());
    ...
    static void handleApplicationClosing(final Context context, int keyCode) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (currentTask.topActivity.equals(currentTask.baseActivity)
                ...
                AndHandApplication application = (AndHandApplication) context
